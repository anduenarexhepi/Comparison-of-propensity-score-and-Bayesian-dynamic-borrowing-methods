...
# RESULT MATRIX
result_ps_map           <- matrix(data=NA, nrow = 16, ncol = 8)
colnames(result_ps_map) <- names
...
for(i in 1:16){
  ...
  result_ps_map[i, ]  <- 
    Manduena::PS_MAP_2(n_sim=repl, sim_data=sim_data)
}

result_ps_map = as.data.frame(result_ps_map) 
round(result_ps_map, digits = 2)
...
# RESULT MATRIX
result_ps_map_mht_i     <- matrix(data=NA, nrow = 25, ncol = 8)
colnames(result_ps_map_mht_i)   <- names
...
for(i in 1:25){
  ...
  result_ps_map_mht_i[i,] <- 
    Manduena::PS_MAP_2(n_sim=repl, sim_data=sim_data)
}

result_ps_map_mht_i = as.data.frame(result_ps_map_mht_i)
round(result_ps_map_mht_i, digits=2)
...
# RESULT MATRIX
result_ps_map_mht_ii    <- matrix(data=NA, nrow = 25, ncol = 8)
colnames(result_ps_map_mht_ii)  <- names
...
for(i in 1:25){
  ...
  result_ps_map_mht_ii[i,]    <- 
    Manduena::PS_MAP_2(n_sim=repl, sim_data=sim_data)
  
}

result_ps_map_mht_ii = as.data.frame(result_ps_map_mht_ii)
round(result_ps_map_mht_ii, digits=2)
...
# RESULT MATRIX
result_ps_map_mht_iii   <- matrix(data=NA, nrow = 25, ncol = 8)
colnames(result_ps_map_mht_iii) <- names
...
for(i in 1:25){
  ...
  result_ps_map_mht_iii[i,]    <- 
    Manduena::PS_MAP_2(n_sim=repl, sim_data=sim_data)
  
}

result_ps_map_mht_iii = as.data.frame(result_ps_map_mht_iii)
round(result_ps_map_mht_iii, digits=2)
